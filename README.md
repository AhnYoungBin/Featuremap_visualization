...
Cat and Dog Dataset 에서 accuracy 91.95%의 학습된 VGG16 Model를 기반으로 제작. 자세한 모델 구조는 Code 참고   


설명
------
tensorflow 2.0 으로 구현한 Convolution layer featuremap 시각화 코드   
"케라스 창시자에게 배우는 딥러닝"이라는 교재를 참조하여 제작   
